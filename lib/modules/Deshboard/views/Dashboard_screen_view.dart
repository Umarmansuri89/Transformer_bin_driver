                                              ...
                                              if(controller.items[index].delivery_status=="0"){
                                                    ...
                                                    onExpansionChanged: (expanded) {
                                                      setState(() {
                                                        if (expanded) {
                                                          ...
                                                          if(controller.Colorlist[index]==index){
                                                        ...
                                                        child: Row(
                                                          children: <Widget>[
                                                            ...
                                                            Expanded(
                                                              flex: 0,
                                                              child: Padding(
                                                                  padding: EdgeInsets.only(left: 5,right: 20,bottom: 10,top: 0),
                                                                  child: SvgPicture.asset("assets/Images/drop.svg")
                                                              ),
                                                            ):
                                                            SizedBox(),
                                                ...
                                                return Container(
                                                  ...
                                                  child: ExpansionTileCard(
                                                    ...
                                                    children:[
                                                      Container(
                                                        padding: EdgeInsets.only(left: 05,right: 40),
                                                        child:Row(
                                                          //mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                                          children: [
                                                ...
                                                return Container(
                                                  ...
                                                  child: ExpansionTileCard(
                                                        ...
                                                        child: Row(
                                                          children: <Widget>[
                                                            ...
                                                            Expanded(
                                                              ...
                                                              child: Padding(
                                                                  padding: EdgeInsets.only(left: 5,right: 20,bottom: 10,top: 0),
                                                                  child: SvgPicture.asset("assets/Images/move_down.svg")
                                                              ),
                                                            ):
                                                            SizedBox(),
                                                            Expanded(
                                                    ...
                                                    children:[
                                                      Container(
                                                        padding: EdgeInsets.only(left: 05,right: 45),
                                                        child:Row(
                                                          // mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                          children: [
                                                            ...
                                                            Expanded(
                                                              ...
                                                              child:  GestureDetector(
                                                                ...
                                                                child: Row(children: [
                                                                  ...
                                                                  Container(
                                                                    margin: const EdgeInsets.only(left: 02,top: 8),
                                                                    child: TextFieldShow(
                                                                      text: "Exchange",
                                                                      color:ColorValues.Lite_black,
                                                                      fontsize: 10,
