...
class Schedule_View extends StatefulWidget {
  const Schedule_View({Key? key}) : super(key: key);

  @override
  State<Schedule_View> createState() => _Schedule_ViewState();
}

class _Schedule_ViewState extends State<Schedule_View> {
  ...
  Schedule_controller controller = Get.put(Schedule_controller());
   ...
   Widget build(BuildContext context) {
     ...
     return Scaffold(
         ...
         appBar: appbar_Scner( "13/07/2022", onTap ),
         body:
